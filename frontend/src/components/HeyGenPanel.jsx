...
export default function HeyGenPanel({
  ...
  const canGenerate = selectedAvatarId && selectedVoiceId && selectedPrompt && !loading
    ...
    <div className="heygen-panel">
      ...
      {config && (
        <div className="hgp-body">
          ...
          {/* No prompt warning */}
          {!selectedPrompt && (
            <p className="hgp-no-prompt">
              ↑ Select a prompt above in the Cinematic section first — HeyGen uses the same creative direction.
            </p>
          )}
